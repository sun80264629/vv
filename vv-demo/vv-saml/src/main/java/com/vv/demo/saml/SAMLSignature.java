...
import com.vv.demo.security.KeyStoreUtil;
import com.vv.demo.xml.PrettyPrinter;
...
public class SAMLSignature
{
    ...
    */
        ...
        throws Exception
    {
        if (args.length < 2)
        {
            System.out.println ("Usage: java com.vv.demo.saml.SAMLSignature " + 
        ...
        if (command.equals ("sign"))
        {
            if (args.length < 3)
            {
                System.out.println ("Usage: java com.vv.demo.saml.SAML " + 
